...
- 🐛 Bound antialiasing checks to shared image area

**Full Changelog**: https://github.com/vizzly-testing/honeydiff/compare/v0.13.0...v0.13.1
...
- 🛠️ Remove release npm self-upgrade (#30)
- 🛠️ Harden release workflows (#29)
- 🧪 Give coverage tests more time (#28)
- 🛡️ Harden honeydiff production contracts (#27)
- 🐛 Fix honeydiff-core clippy warnings
- 🧪 Add diff contract test suite

**Full Changelog**: https://github.com/vizzly-testing/honeydiff/compare/v0.10.1...v0.10.2
